...
function Navbar(props) {
    ...
    return <nav>
        ...
        <section className="second-nav-section">
            <div>
                ...
                <div className="user-info-div">
                    ...
                    <Link to="#" className="user-info-link wishlist-p">
                    ...
                    <Link to="#" className="user-info-link login-p">
        ...
        <section className="third-nav-section">
            <div>
                <Link to="#" className="third-section-p"><p>Men</p></Link>
                <Link to="#" className="third-section-p"><p>Women</p></Link>
                <Link to="#" className="third-section-p"><p>Unisex</p></Link>
                <Link to="#" className="third-section-p"><p>Kids</p></Link>
                <Link to="#" className="third-section-p"><p>Best Sellers</p></Link>
                <Link to="#" className="third-section-p"><p>New Arrivals</p></Link>
                <Link to="#" className="third-section-p offers-p"><p>Offers</p></Link>
            </div>
        </section>

        <section className="fourth-nav-section">
            <div>
                <Link to="#" className="fourth-section-p"><span>Men</span></Link>
                <span>/</span>
                <Link to="#" className="fourth-section-p"><span> Clothing</span></Link>
                <span>/</span>
                <Link to="#" className="fourth-section-p"><span> Tops</span></Link>
                <span>/</span>
                <Link to="#" className="fourth-section-p"><span> Reebok</span></Link>
                <span>/</span>
